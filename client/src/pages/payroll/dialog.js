...
export default function FormDialog({open,handleClose,data,onChange,handleFormData}) {
  const {payroll,jan,feb,mar,apr,may,jun,jul,aug,sep,oct,nov,dec}=data;
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <form>
          <TextField id="payroll" onChange={e=>onChange(e)} value={payroll} placeholder='Enter the employee name' label="Employeename" variant="outlined" margin="dense" fullWidth/>
