...
export default function FormDialog({open,handleClose,data,onChange,handleFormData}) {
  const {vendors,jan,feb,mar,apr,may,jun,jul,aug,sep,oct,nov,dec}=data;
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <form>
            Vendor name<TextField id="vendors" onChange={e=>onChange(e)} value={vendors} placeholder='Enter the vendor name' label="Enter the vendor name" variant="outlined" margin="dense" fullWidth/>
