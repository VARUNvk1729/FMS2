  ...
  return (
    <div>
      ...
      >
        ...
        <DialogContent>
          <form>
          <TextField id="expense" onChange={e=>onChange(e)} value={expense} placeholder='Enter the employee name' label="Employeename" variant="outlined" margin="dense" fullWidth/>
