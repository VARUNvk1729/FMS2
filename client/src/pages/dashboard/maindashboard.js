  ...
  return (
    ...
    <div className="MC">
      <div className="statistics">
        <div className="statisticsi" style={{marginLeft:'80px'}}>
      <div className="profitloss" style={{width:'20%', height:'180px'}}>
      ...
      <div className="box" style={{marginLeft:'100px'}}>
       ...
       <div className="box" style={{marginLeft:'100px',marginRight:'150px'}}>
         <h3 style={{marginRight:'65px',textAlign:'left',paddingTop:'15px',paddingLeft:'10px'}}>
           Total Vendors
         </h3><hr/>
         <p style={{textAlign:'center', fontSize:'25px'}}>
