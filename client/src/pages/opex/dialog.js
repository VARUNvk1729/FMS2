...
export default function FormDialog({open,handleClose,data,onChange,handleFormData}) {
  const {expense,jan,feb,mar,apr,may,jun,jul,aug,sep,oct,nov,dec}=data;
  ...
  return (
    <div style={{ backgroundColor: 'pink'}}>
      ...
      >
        ...
        <DialogContent>
          <form>
            Expense type: <TextField id="expense" onChange={e=>onChange(e)} value={expense} label='Enter the type of expense' placeholder="Enter the type of expense" variant="outlined" margin="dense" fullWidth/><br/>
