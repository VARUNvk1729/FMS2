...
import { COLUMNS } from "../office/columns";
import { mock } from "../office/expensesdata";
//import '../table.css'
...
import { updateFunc } from "../office/update";
...
export const OfficeTable = (props) => {
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workBook, workSheet, "officeExpense");
    let buf = XLSX.write(workBook, { bookType: "xlsx", type: "buffer" });
    XLSX.write(workBook, { bookType: "xlsx", type: "binary" });
    XLSX.writeFile(workBook, "OfficeExpense.xlsx");
  };
  ...
  const handleUpdate = (id) => {
    ...
    console.log(upobj);
    //console.log(data[id].CashFlow);
    fetch(`http://localhost:8000/office/updateRow/${data[id].expenses}`, {
      method: "PUT",
